    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="list-group">
                ...
                <a href="#item1" class="list-group-item color_menu" data-parent="#MainMenu" data-toggle="collapse" onclick="cargarVistaTareas_1_0()"><strong>1. Establecer requisitos de la evaluación</strong></a>
                ...
                <a href="#item2" class="list-group-item color_menu" data-parent="#MainMenu" data-toggle="collapse" onclick="cargarVistaTareas_2_0()"><strong>2. Especificar la evaluación</strong></a>
                ...
                <a href="#item3" class="list-group-item color_menu" data-parent="#MainMenu" data-toggle="collapse" onclick="cargarVistaTareas_3_0()"><strong>3. Diseñar la evaluación</strong></a>
                <div class="collapse" id="item3">
                    <a href="#" class="list-group-item" onclick="cargarVistaTareas_3_1()">- Actividades de la evaluación</a>
                </div>
                <a href="#item4" class="list-group-item color_menu" data-parent="#MainMenu" data-toggle="collapse" onclick="cargarVistaTareas_4_0()"><strong>4. Ejecutar la evaluación</strong></a>
                <div class="collapse" id="item4">
                    <a href="#" class="list-group-item" onclick="cargarVistaTareas_4_1()">- Mediciones</a>
                </div>
                <a href="#item5" class="list-group-item color_menu" data-parent="#MainMenu" data-toggle="collapse" onclick="cargarVistaTareas_5_0()"><strong>5. Concluir la evaluación</strong></a>
